 ...
 * NODES
 */
export declare type Node = Root | Paragraph | Heading | ThematicBreak | Blockquote | List | ListItem | Table | TableRow | TableCell | HTML | Code | YAML | FootnoteDefinition | Text | Emphasis | Strong | Delete | InlineCode | Break | Link | Image | LinkReference | ImageReference | Footnote | FootnoteReference | Definition;
...
export interface Root extends Parent, unist.Node {
    type: "root";
}
...
*/
export interface Definition extends Association<LinkReference | ImageReference>, Resource, unist.Node {
    type: "definition";
}
/** content relating to document outside of the flow
 * @example markdown`[^alpha]: bravo and charlie.`
 */
export interface FootnoteDefinition extends Parent, unist.Node, Association<FootnoteReference> {
...
*/
export interface LinkReference extends Parent, Reference<Definition> {
    type: "linkReference";
    children: Array<StaticPhrasingContent>;
}
 ...
 */
export interface ImageReference extends unist.Node, Reference<Definition>, Alternative {
    type: "imageReference";
}
/**
 ...
 * @example markdown`[^alpha]`
*/
export interface FootnoteReference extends unist.Node, Association<FootnoteDefinition> {
    type: "footnoteReference";
}
/**
 * ENUMS
 */
export declare type specifiedAlignTypes = "left" | "right" | "center";
 ...
 */
export declare type AlignType = specifiedAlignTypes | null;
/**
 * reference is implicit; identifier inferred from content
 * @example markdown`[MyWebsite]`
*/
declare type rtype_shortcut = "shortcut";
/**
 * reference explicit; identifier inferred from content
 * @example markdown`[][MyWebsite]`
 */
declare type rtype_collapsed = "collapsed";
/**
 * reference is explicit. identifier explicitly set
 * @example markdown`[MyWebsite][MyWebsite]`
 */
declare type rtype_full = "full";
export declare type referenceType = rtype_shortcut | rtype_collapsed | rtype_full;
/**
 * CONTENT
 */
